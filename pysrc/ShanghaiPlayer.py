...
def play_midi():
    ...
    for message in mid.play():  #Next note from midi in this moment
        ...
        if 'note_on' == message.type :
            port.write("144 " + str(message.note-16) + " " + str(message.velocity) + "\r")
            ...
            #port.write("128 " + str(message.note) + " " + str(message.velocity) + "\r")
...
try:
    ...
    port = serial.Serial("\\\\.\\COM24", baudrate=115200)
